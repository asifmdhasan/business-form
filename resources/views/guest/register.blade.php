            ...
            <div class="card shadow-sm">
                <div class="card-body p-4">
                    ...
                    <h3 class="fw-bold mb-4">
                        <i class="fa fa-building me-2"></i> Guest Business Registration
                    </h3>
                    ...
                    <form method="POST" action="{{ route('guest.save-step') }}" enctype="multipart/form-data" class="pt-3">
                        @csrf
                        ...
                        <div class="d-flex justify-content-between mt-4">
                            @if($step > 1)
                                <a href="{{ route('guest.form', ['step' => $step - 1, 'business_id' => $business->id ?? '']) }}"

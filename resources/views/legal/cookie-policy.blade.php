        ...
        <div class="row justify-content-center">
            <div class="col-lg-9">
                <div class="legal-card">
                    ...
                    <p class="legal-intro">
                        The Global Muslim Business Directory uses cookies to improve website functionality 
                        and user experience.
                    </p>

                    <div class="legal-section-block">
                        <h2 class="legal-heading"><span class="legal-num">1.</span> What Are Cookies</h2>
                        <p>
                    ...
                    <div class="legal-section-block">
                        <h2 class="legal-heading"><span class="legal-num">2.</span> How We Use Cookies</h2>
                        ...
                        <p>We do not use cookies to track users for advertising purposes.</p>
                    </div>

                    <div class="legal-section-block">
                        <h2 class="legal-heading"><span class="legal-num">3.</span> Managing Cookies</h2>
                        <p>
                            You may choose to disable cookies through your browser settings. Please note that 
                            some features of the directory may not function properly without cookies.
                        </p>
                    </div>
